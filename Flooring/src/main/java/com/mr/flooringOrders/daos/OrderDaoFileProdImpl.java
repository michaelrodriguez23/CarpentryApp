...
public class OrderDaoFileProdImpl implements OrderDao {
    ...
    public void writeLibrary(LocalDate selectedDate) throws PersistenceException, FileNotFoundException {
        ...
        try {
            ...
            out = new PrintWriter(new FileWriter("/Users/michaelrodriguez/Documents/OnlineProjects/Code/SoftwareGuildBootCamp/Summatives/CarpentryApp/Flooring/data/" + orderFileName));
